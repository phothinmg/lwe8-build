...
function rep(str) {
    var _a;
    var rex = /\".*\"/g;
    var wm = str.match(rex) ? (_a = str.match(rex)) === null || _a === void 0 ? void 0 : _a[0] : "";
    wm = wm === null || wm === void 0 ? void 0 : wm.replace(/"/g, "");
    return str.replace(rex, "\"".concat(wm, ".js\""));
}
...
// --
var isNotTs = function (str) {
    return extname(str) !== ".ts" && extname(str) !== ".mts" && extname(str) !== ".cts";
};
// --
